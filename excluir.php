...
<body>
<a href="listar.php" class="w3-display-topmiddle w3-red w3-center w3-padding w3-button" style="text-decoration:none;">
...
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
    ...
    <form action="excluirAction.php" class="w3-container" method='post'>
        ...
        <input name="txtApelido" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['apelido']?>"><br>
        
        <label class="w3-text-teal" style="font-weight: bold;">Email</label>
        <input name="txtEmail" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['email']?>"><br>
